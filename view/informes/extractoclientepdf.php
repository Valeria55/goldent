...
$html1 = <<<EOF
		...
		<h3 align="center">Deudas de $cli->nombre</h3>
	...
	if ($d->id_venta == 0) {
		$html1 = <<<EOF
				<table width"100%" style="border: 1px solid #333; font-size:7px">
					<tr align="center">
						<td width="50%" style="border-left-width:1px ; border-right-width:1px">$d->concepto</td>
						<td width="10%" style="border-left-width:1px ; border-right-width:1px"></td>
						<td width="20%" style="border-left-width:1px ; border-right-width:1px">$d->monto</td>
						<td width="20%" style="border-left-width:1px ; border-right-width:1px">$d->monto</td>
					</tr>
				</table>
		...
		foreach ($this->venta->Listar($d->id_venta, $_REQUEST['desde'], $_REQUEST['hasta']) as $r) :
