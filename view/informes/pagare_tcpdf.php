...
$html = '<h3 style="text-align: center;">PAGARÉ A LA ORDEN</h3>
<table border="0" cellpadding="5">
<tr>
<td style="font-size: 10px;"><b>Factura:</b> ' . $venta->nro_comprobante. '</td>
<td style="font-size: 10px;"><b>Gs:</b> ' . number_format($venta->total, 0, ',', '.') . '</td>
</tr>
<tr>
<td style="font-size: 10px;">Ciudad del Este, ' . $dia . ' de ' . $mesLetra . ' de ' . $anio . '</td>
<td style="font-size: 10px;"><b>Vencimiento:</b> ' . $fecha_vencimiento . '</td>
</tr>
<tr>
<td colspan="2"><b>Pagará a:</b> Goldent S.A</td>
</tr>
<tr>
<td colspan="2">o a su orden la cantidad de Gs: <b style="font-size: 10px;"> ' . $valor_letra . '</b></td>
</tr>
</table>
...
<table border="0" cellpadding="5">
<tr>
<td style="font-size: 10px;"><b>Nombre:</b> ' . $venta->cliente . '</td>
</tr>
<tr>
<td style="font-size: 10px;"><b>Domicilio:</b> ' . $venta->direccion . '</td>
</tr>
<tr>
<td style="font-size: 10px;"><b>CI Nº:</b> ' . $venta->ruc . '</td>
</tr>
</table>
