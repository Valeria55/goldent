...
<table class="table table-striped table-bordered display responsive nowrap" width="100%" id="tabla1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Total Rs: <div id="totalrs" style="font-size: 30px"><img src="http://www.customicondesign.com/images/freeicons/flag/round-flag/48/Brazil.png"></i><?php echo ($cierre->cot_real >0 )? number_format(($subtotal / $cierre->cot_real), 2, ",", ".") : ''; ?></div>
            </td>
...
<div align="center"><a class="btn btn-lg btn-primary " href="#finalizarModal" class="btn btn-success" data-toggle="modal" data-target="#finalizarModal" data-c="transferencia_producto">Finalizar (F4)</a></div>
