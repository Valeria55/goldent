<h1 class="page-header">Inventario <?php
    ...
    <a class="btn btn-primary" href="?c=inventario&a=guardar" class="btn btn-success">Nuevo Inventario</a>
</h1>

<a class="btn btn-info pull-right" align="center" href="?c=cierre_inventario&a=Cierreinventario">Informe de Inventario </a>
