...
$pdf->SetTitle('Informe de Ventas Facturadas');
...
<div class="header">
    ...
    <div class="title">LISTA DE VENTAS FACTURADAS:</div>
</div>
...
$ventas = $this->venta->ListarVentasPorComprobante($_REQUEST['desde'], $_REQUEST['hasta'], true);
$totalVenta = 0;
foreach ($ventas as $v) {
...
$pdf->Output("Ventas_Facturadas_$desde-$hasta.pdf", 'I');
