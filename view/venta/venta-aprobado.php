<table id="tabla2" class="table table-striped table-bordered display responsive" width="100%">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        let tablaUsuarios = $('#tabla2').DataTable({
            ...
            <?php if (isset($_GET['desde'])) { ?> "ajax": {
                    "url": "?c=venta&a=ListarFiltrosAprobado&desde=<?php echo $_GET['desde'] ?>&hasta=<?php echo $_GET['hasta'] ?>",
                    "dataSrc": ""
                },
            <?php } else { ?>

                "ajax": {
                    "url": "?c=venta&a=ListarAjaxAprobado",
                    "dataSrc": ""
                },
            <?php } ?>
            ...
            "columns": [{
                ...
                <?php } ?> {
                    ...
                    render: function(data, type, row) {
                        ...
                        return "<a href='#detallesModal' class='btn btn-info' data-toggle='modal' data-target='#detallesModal' data-c='venta' data-tabla='aprobado' data-id='" + row.id_venta + "'>Ver</a>";
                ...
                ?> {
                        ...
                        render: function(data, type, row) {
                            if (row.anulado == 1) {
                                ...
                                return '<a href="' + link + '" class="btn btn-danger" onclick="return confirm(\'¿Seguro de anular este registro?\');">Eliminar</a>';
                            }
                        }
                    },
                <?php } ?> {
