 ...
 <table class="table table-striped table-bordered display responsive nowrap" width="100%" id="tabla1">
    ...
    <?php endforeach; ?>
        ...
        <tr>
            ...
            <td>Total Rs: <div id="totalrs" style="font-size: 30px"><img src="http://www.customicondesign.com/images/freeicons/flag/round-flag/48/Brazil.png"></i><?php echo ($cierre && $cierre->cot_real > 0 ? ($cierre && $cierre->cot_real > 0 ? number_format(($subtotal/$cierre->cot_real), 2, "," , ".") : "---") : "---") ?></div></td>
            <td>Total Us: <div id="totalus" style="font-size: 30px"><img src="http://www.customicondesign.com/images/freeicons/flag/round-flag/48/USA.png"></i><?php echo ($cierre && $cierre->cot_dolar > 0 ? ($cierre && $cierre->cot_dolar > 0 ? number_format(($subtotal/$cierre->cot_dolar), 2, "," , ".") : "---") : "---") ?></div></td>
            <td></td>
            <td></td>
        </tr>
    </tbody>
