    ...
    <div class="row">
        <form method="post" id="productoNuevo">
            ...
            <div class="col-sm-3">
                ...
                <input type="text" name="paciente" class="form-control" id="paciente" value="">
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <label>Precio</label>
                <input type="number" name="precio_venta" class="form-control" id="precio_venta" value="" step="any" min="0" required>
            </div>
            <div class="col-sm-2">
                <label>Descuento (%)</label>
                <input type="number" name="descuento" class="form-control" id="descuento" value="0" max="10">
    ...
    $('#producto').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                $("#precio_venta").html(producto.precio_minorista);
                // }
