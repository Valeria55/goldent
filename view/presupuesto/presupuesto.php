                    ...
                    render: function(data, type, row) {
                        ...
                        if (row.adelantos_info && row.adelantos_info.length > 0) {
                            row.adelantos_info.forEach(function(ade) {
                                ...
                                totalFormatted += '<br><span class="label label-info" style="font-size: 10px; display: inline-block; margin-top: 2px;" title="Adelanto vinculado"><i class="fas fa-hand-holding-usd"></i> Adelanto: ' + txt + '</span>';
                            });
                        }
