...
<h1 class="page-header">Nuevo presupuesto de compra <a class="btn btn-primary" href="#productoModal" class="btn btn-success" data-toggle="modal" data-target="#crudModal" data-c="producto">Nuevo producto</a> </h1>


    <div class="row">
        <form method="post" action="?c=presupuesto_compra_tmp&a=guardar">
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
            ...
            <!--<input type="hidden" value="" id="precio_may" name="precio_may" class="form-control" required>     --> 
             <input class="btn btn-primary center-block" style="visibility:hidden;" type="submit" name="bton" value="Confirmar" onclick="this.disabled=true;this.value='Guardando, Espere...';this.form.submit();">
        </div>
    </form>
    </div>
    ...
    <?php
     ...
     foreach($this->model->Listar() as $r): 
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=presupuesto_compra_tmp&a=Eliminar&id=<?php echo $r->id; ?>">Cancelar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
<div align="center">
    ...
    <a class="btn btn-lg btn-danger delete" href="?c=presupuesto_compra_tmp&a=CancelarPresupuesto">Cancelar Todo</a>
</div>
