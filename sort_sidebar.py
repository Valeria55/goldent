...
file_path = r'c:\xampp\htdocs\goldent\view\sidebar.php'
with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

prefix_pattern = r'(.*?)(\s*<\?php if \(\$_SESSION\[\'nivel\'\] == 1\) \{ \?>)'
suffix_pattern = r'(\s*<\?php //NIVEL 4 ESPECIAL \?>.*)'

prefix_match = re.search(prefix_pattern, content, flags=re.DOTALL)
suffix_match = re.search(suffix_pattern, content, flags=re.DOTALL)
...
if prefix_match and suffix_match:
    ...
    new_nivel_1 = '''
        ...
        <?php } ?>
'''
    new_content = prefix + new_nivel_1 + suffix
