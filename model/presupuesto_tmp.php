...
class presupuesto_tmp
{
	...
	public function Listar()
	{
		try
		{
			...
			$stm = $this->pdo->prepare("SELECT v.id, v.id_producto,v.descuento, p.codigo, v.id_vendedor, v.precio_venta, p.producto, p.precio_costo, v.cantidad, v.id_presupuesto, v.id_sucursal
